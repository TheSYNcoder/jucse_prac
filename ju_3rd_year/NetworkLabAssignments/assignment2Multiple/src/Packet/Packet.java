...
public class Packet {
    ...
    public static String getSrcAdd(String codeword) {
        Packet p = toPacket(codeword);
        return p.getSrcAdd();
    }

    public static String getDesAdd(String codeword) {
        Packet p = toPacket(codeword);
        return p.getDesAdd();
    }
    ...
    public String toString() {
        return "PACKET TYPE: " + type + " SEQ. NO: " + String.valueOf(seqNumber) + " SRC: " +
                String.valueOf(convert_into_number(source)) + " DES: " + String.valueOf(convert_into_number(destination));
